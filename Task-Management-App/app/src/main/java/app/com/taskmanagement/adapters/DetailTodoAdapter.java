...
public class DetailTodoAdapter extends RecyclerView.Adapter{
    ...
    public DetailTodoAdapter(Context context, Long taskId, HashMap<Long, String> approveList, HashMap<Long, String> roleList, HashMap<Long, String> statusList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DetailTaskPendingAdapter.TaskFormHolder(view);
    }
...
//                    String splitEnddate = object.getEndTime().toString();
        if (dataLoaded) {
            ...
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueTaskname.setText(taskModel.getTaskName().toString());
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueIDtask.setText(taskModel.getTaskId().toString());
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueOldID.setText(taskModel.getOldTaskId() != null ? taskModel.getOldTaskId().toString() : "None");

            //                    -Choose date and time of deadline-
            final Button valueDeadline = ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueDateDeadline;
            final Button valueTimeDeadline = ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueTimeDeadline;
//                    Choose date
...
//                    Choose time
            ...
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueNote.setText(note);

            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueDescription.setText(taskModel.getDescription());
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueStartdate.setText(taskModel.getStartTime() != null ? taskModel.getStartTime().toString() : "");
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueEnddate.setText(taskModel.getEndTime() != null ? taskModel.getStartTime().toString() : "");
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueResult.setText(taskModel.getResult() != null ? taskModel.getResult().toString() : "");
            ...
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueStatus.setAdapter(statusAdapter);
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueStatus.setSelection(taskModel.getStatus().intValue());

            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueCreator.setText(creator.getFullName());
...
//                    ((UpdateTaskHolder) holder).valueImgResolution.setTag(object.getAssignee());
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueReviewer.setText("");
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueDateReview.setText("");
            if (taskModel.getMark() == null) {
                ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueMark.setVisibility(View.INVISIBLE);
            } else {
                ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueMark.setValue(taskModel.getMark().intValue());
            }
            ((DetailTaskPendingAdapter.TaskFormHolder) holder).valueReview.setText("");
        }
