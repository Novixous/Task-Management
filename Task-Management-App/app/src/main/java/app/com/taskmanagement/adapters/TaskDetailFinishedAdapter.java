...
public class TaskDetailFinishedAdapter extends RecyclerView.Adapter {
    ...
    public TaskDetailFinishedAdapter(Context context, Long taskId, HashMap<Long, String> approveList, HashMap<Long, String> roleList, HashMap<Long, String> statusList) {
