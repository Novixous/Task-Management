    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (mode) {
            case MODE_PENDING:
                ...
                break;
            case MODE_TODO:
                detailTaskAdapter = new DetailTodoAdapter(this.getActivity(), this, taskId, approveList, roleList, statusList);
                break;
            case MODE_FINISHED:
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == 1000) {
                ...
                try {
                    ...
                    ((DetailTodoAdapter) detailTaskAdapter).setImageResolution(bitmapImage);
